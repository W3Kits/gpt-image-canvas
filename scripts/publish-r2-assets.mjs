...
const bucketName = process.env.W3KITS_PLUGIN_BUCKET_NAME || "w3kits-plugin-gpt-image-canvas";
...
console.log(
  JSON.stringify({
    bucketName,
    tarball: `https://plugin-gpt-image-canvas.w3kits.com/__w3kits/package.tgz`,
    integrity,
    uploadedObjects,
    uploadedBytes,
  }),
